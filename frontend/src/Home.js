...
import { FaGrinStars, FaHubspot, FaRegFileAlt, FaBookOpen } from 'react-icons/fa';
            ...
            <div className="home--Container">
                ...
                <main className="home--Body">
                    <div className="top--Image">
                        <img src={iphone} alt="iphone picture" />
                    </div>
                    ...
                    <div className="home--Section--Boxes--Container--Transparent">
                        ...
                        <div className="home--Section--Box--Middle">
                    ...
                    <div className="home--Section--Preview">
                        <div className="preview--First">
                            ...
                            <img src={aboutProductsPicture} alt="about products picture" />
                            <div className="first--About">
                                <h3><FaBookOpen color={'#1E718D'}/> Choose from hundred of products</h3>
